...
@Component({
  selector: 'app-find-related',
  templateUrl: './find-related.component.html',
  styleUrls: ['./find-related.component.css']
})
export class FindRelatedComponent implements OnInit {
  allProducts = [
    {
      id: 1,
    ...
    },
    {
      ...
      qty: 1,
      price: 129.99,
      photo: 'assets/images/Image 2.png'
    }
  ];
  searchedItems = [
  ];
  ...
  ngOnInit() {
    ...
    console.log(this.addedItems.length);
  }
